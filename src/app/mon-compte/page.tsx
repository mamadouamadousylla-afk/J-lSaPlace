...
export default function ProfilePage() {
    ...
    const selectStandardLogin = () => {
        setShowLoginTypeChoice(false)
        setAuthMode('login')
        setShowAuthModal(true)
    }

    const selectPromoterLogin = () => {
        setShowLoginTypeChoice(false)
            ...
            <>
                ...
                <SignupTypeModal
                    ...
                    onSelectPromoter={() => {
                        ...
                        window.location.href = '/promoteur/inscription'
                    }}
                />
            </>
        )
                ...
                <div className="p-6 space-y-4">
                    ...
                    >
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                <div className="flex items-center gap-2">
                                    <h3 className="font-bold text-gray-900 text-lg">Compte Partenaire</h3>
