    ...
    return (
        <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-black p-6 pt-16 pb-32 space-y-8">
            <div className="flex items-center justify-between">
                <h1 className="text-2xl font-poppins font-bold">Mes Tickets</h1>
            ...
            <div className="space-y-2">
                <h2 className="text-lg font-bold">Jërejëf ! Ton ticket est prêt.</h2>
                <p className="text-gray-500 text-sm">Présentez ce QR Code à l&apos;entrée de l&apos;arène.</p>
            </div>
            ...
            >
                <div className="bg-white dark:bg-gray-900 rounded-[3rem] overflow-hidden shadow-2xl border border-gray-100 dark:border-gray-800">
                    ...
                    <div className="p-8 space-y-8 relative">
                        ...
                        <div className="absolute -left-4 top-0 w-8 h-8 rounded-full bg-gray-50 dark:bg-black -translate-y-1/2" />
